            ...
            <Stack direction="column" divider={ <Divider/>} spacing={2} sx={{ my:2 }}>
                <div>
                    <Typography variant="subtitle2" gutterBottom 
                        ...
                        <DeliveryDiningIcon color="secondary" sx={{ mr : 2}}/>Teslimat Bilgileri</Typography>
                    ...
                    <Typography gutterBottom sx={{color:"text.secondary"}}>{getValues("adressline")} / {getValues("city")}</Typography>
                </div>
                <div>
                    <Typography variant="subtitle2" gutterBottom 
                        sx={{ display:"flex", alignItems:"center", mb:2}}>
                        <PaymentsIcon color="secondary" sx={{ mr : 2}}/>Ödeme Bilgileri</Typography>
                    <Typography gutterBottom sx={{color:"text.secondary"}}>{getValues("card_name")}  {getValues("lastname")}</Typography>
