            ...
            <Dialog onClose={handleDialogClose} open={open} fullWidth maxWidth="lg"
                ...
                <DialogContent dividers>
                    <Paper sx={{ p:3, mb:3}}>
                        ...
                        <Typography gutterBottom>{selectedOrder?.adressLine} / {selectedOrder?.city}</Typography>
                    </Paper>
                    <TableContainer component={Paper}>
                        <Table>
                            ...
                            <TableBody>
                                {selectedOrder?.orderItems.map( (item) => (
                                    <TableRow key={item.id}>
                                        <TableCell>
                                            <img src={`http://localhost:5264/images/${item.productImage}`} style={{ height: 60 }}></img>
                                        </TableCell>
